def main(**kwargs):
    ...
    if 'QBIT_q0' in kwargs:
        QBIT_q0 = kwargs['QBIT_q0']
    else:
        QBIT_q0 = QubitFactory('q0')
    ...
    seqs = list()
    seq_QBIT_q0 = [
        Barrier('seq_0_1', [QBIT_q0, QBIT_q1, QBIT_q2]),
        Barrier('concur_beg_5', [QBIT_q0, QBIT_q1]),
        ...
        Barrier('concur_end_5', [QBIT_q0, QBIT_q1]),
        Barrier('seq_1_1', [QBIT_q0, QBIT_q1, QBIT_q2]),
        Barrier('eseq_2_1', [QBIT_q0, QBIT_q1, QBIT_q2])
    ]
    seqs += [seq_QBIT_q0]
    seq_QBIT_q1 = [
        Barrier('seq_0_1', [QBIT_q0, QBIT_q1, QBIT_q2]),
        ...
        Barrier('concur_end_5', [QBIT_q0, QBIT_q1]),
        Barrier('seq_1_1', [QBIT_q0, QBIT_q1, QBIT_q2]),
        Barrier('concur_beg_9', [QBIT_q1, QBIT_q2]),
        BlockLabel('while_start_2'),
        CmpEq(1),
        Goto(BlockLabel('while_end_2')),
        X(QBIT_q1),
        Goto(BlockLabel('while_start_2')),
        BlockLabel('while_end_2'),
        Barrier('concur_end_9', [QBIT_q1, QBIT_q2]),
        Barrier('eseq_2_1', [QBIT_q0, QBIT_q1, QBIT_q2])
    ]
    seqs += [seq_QBIT_q1]
    seq_QBIT_q2 = [
        ...
        Barrier('seq_1_1', [QBIT_q0, QBIT_q1, QBIT_q2]),
        Barrier('concur_beg_9', [QBIT_q1, QBIT_q2]),
        BlockLabel('while_start_3'),
        CmpEq(1),
        Goto(BlockLabel('while_end_3')),
        X(QBIT_q2),
        Goto(BlockLabel('while_start_3')),
        BlockLabel('while_end_3'),
        Barrier('concur_end_9', [QBIT_q1, QBIT_q2]),
        Barrier('eseq_2_1', [QBIT_q0, QBIT_q1, QBIT_q2])
    ]
    seqs += [seq_QBIT_q2]

def main(**kwargs):
    ...
    seq_QBIT_q1 = [
        ...
        Barrier('seq_0_2', [QBIT_q1, QBIT_q2]),
        Barrier('seq_0_4', [QBIT_q1, QBIT_q2]),
        X90(QBIT_q1),
        Barrier('seq_1_4', [QBIT_q1, QBIT_q2]),
        Barrier('eseq_2_4', [QBIT_q1, QBIT_q2]),
        Barrier('seq_0_5', [QBIT_q1, QBIT_q2]),
        X90(QBIT_q1),
        Barrier('seq_1_5', [QBIT_q1, QBIT_q2]),
        Barrier('eseq_2_5', [QBIT_q1, QBIT_q2]),
        Barrier('eseq_1_2', [QBIT_q1, QBIT_q2]),

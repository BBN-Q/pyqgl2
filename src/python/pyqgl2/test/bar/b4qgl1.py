def main(**kwargs):
    ...
    seq_QBIT_q1 = [
        ...
        Barrier('concur_beg_6', [QBIT_q1, QBIT_q2, QBIT_q3]),
        Barrier('seq_0_3', [QBIT_q1, QBIT_q2]),
        X90(QBIT_q1),
        Barrier('seq_1_3', [QBIT_q1, QBIT_q2]),
        Barrier('eseq_2_3', [QBIT_q1, QBIT_q2]),
        Barrier('seq_0_5', [QBIT_q1, QBIT_q3]),
        Barrier('seq_1_5', [QBIT_q1, QBIT_q3]),
        Y90(QBIT_q1),
        Barrier('eseq_2_5', [QBIT_q1, QBIT_q3]),
        Barrier('concur_end_6', [QBIT_q1, QBIT_q2, QBIT_q3]),

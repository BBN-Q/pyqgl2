def main(**kwargs):
    ...
    seq_QBIT_q1 = [
        ...
        CmpEq(1),
        Goto(BlockLabel('if_end_6')),
        Barrier('seq_0_10', [QBIT_q1]),
        Xtheta(QBIT_q1, i=2, j=0),
        Barrier('eseq_1_10', [QBIT_q1]),
        BlockLabel('if_end_6'),
        ...
        Xtheta(QBIT_q1, i=3, j=1),
        Barrier('eseq_1_18', [QBIT_q1]),
        BlockLabel('if_end_14'),
        Barrier('eseq_1_17', [QBIT_q1]),
        Barrier('seq_0_19', [QBIT_q1]),
        CmpEq(1),
        Goto(BlockLabel('if_end_16')),
        Barrier('seq_0_20', [QBIT_q1]),
        Xtheta(QBIT_q1, i=3, j=2),
        Barrier('eseq_1_20', [QBIT_q1]),
        BlockLabel('if_end_16'),
        Barrier('eseq_1_19', [QBIT_q1]),
